...
sealed class LoginViewModelState(
    ...
    class LoginViewModel : ViewModel() {
        ...
        fun login(username: String, password: String) {
            ...
            if (isValid) state.value = LoginViewModelState.Success else state.value =
    ...
    fun validLogin(username: String, password: String): Boolean = username == "kotlin" && password == "rocks"
